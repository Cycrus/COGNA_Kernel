...
int main(){
    ...
    nn->_activation_backfall_steepness = 0.047f;

    nn->_short_habituation_curvature = 1.02f;
    nn->_short_habituation_steepness = 0.09f;
    nn->_short_sensitization_curvature = 1.02f;
    nn->_short_sensitization_steepness = 0.09f;
    ...
    nn->_habituation_threshold = 2.0f;
    nn->_sensitization_threshold = 4.0f;
