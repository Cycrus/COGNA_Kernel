...
void DataWriter::write_data(NeuralNetwork *nn){
    ...
    if(nn->_curr_connections.size() > 0){
        for(unsigned int n=1; n<nn->_neurons.size(); n++){
            ...
            _output << nn->_neurons[n]->_activation_backfall_curvature << ",";
            _output << nn->_neurons[n]->_activation_backfall_steepness << ",";
            _output << nn->_neurons[n]->_habituation_threshold << ",";
            _output << nn->_neurons[n]->_sensitization_threshold << ",";
            _output << nn->_neurons[n]->_short_habituation_curvature << ",";
            _output << nn->_neurons[n]->_short_habituation_steepness << ",";
            _output << nn->_neurons[n]->_short_sensitization_curvature << ",";
            _output << nn->_neurons[n]->_short_sensitization_steepness << ",";
            _output << nn->_neurons[n]->_short_dehabituation_curvature << ",";
            _output << nn->_neurons[n]->_short_dehabituation_steepness << ",";
            _output << nn->_neurons[n]->_short_desensitization_curvature << ",";
            _output << nn->_neurons[n]->_short_desensitization_steepness << ",";
            _output << nn->_neurons[n]->_long_habituation_curvature << ",";
            _output << nn->_neurons[n]->_long_habituation_steepness << ",";
            _output << nn->_neurons[n]->_long_sensitization_curvature << ",";
            _output << nn->_neurons[n]->_long_sensitization_steepness << ",";
            _output << nn->_neurons[n]->_long_dehabituation_curvature << ",";
            _output << nn->_neurons[n]->_long_dehabituation_steepness << ",";
            _output << nn->_neurons[n]->_long_desensitization_curvature << ",";
            _output << nn->_neurons[n]->_long_desensitization_steepness << ",";
            _output << nn->_neurons[n]->_presynaptic_potential_curvature << ",";
            _output << nn->_neurons[n]->_presynaptic_potential_steepness << ",";
            _output << nn->_neurons[n]->_presynaptic_backfall_curvature << ",";
            _output << nn->_neurons[n]->_presynaptic_backfall_steepness << ",";
            _output << nn->_neurons[n]->_long_learning_weight_reduction_curvature << ",";
            _output << nn->_neurons[n]->_long_learning_weight_reduction_steepness << ",";
            _output << nn->_neurons[n]->_long_learning_weight_backfall_curvature << ",";
            _output << nn->_neurons[n]->_long_learning_weight_backfall_steepness;
            _output << "\n";
        ...
        _output << nn->_global_min_activation << ",";
        _output << nn->_global_max_activation << ",";
        _output << nn->_global_min_weight << ",";
        _output << nn->_global_max_weight << ",";
        _output << nn->_global_min_transmitter_weight << ",";
        _output << nn->_global_max_transmitter_weight << ",";
